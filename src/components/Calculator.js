...
class Calculator extends React.Component {
  ...
  render() {
    return (
      <div id="Calculator" className="main row container w-25 mx-auto my-5">
        <div className="text-input col-12 px-0"><input placeholder="0" type="text" id="CalculatorDisplay" className="w-100" /></div>
